...
PVSSboolean demoHWService::initialize(int argc, char *argv[])
{
...
PVSSboolean demoHWService::start()
{
...
PVSSboolean demoHWService::writeData(HWObject *objPtr)
{
  if ( Resources::isDbgFlag(Resources::DBG_DRV_USR1) )
    objPtr->debugPrint();
