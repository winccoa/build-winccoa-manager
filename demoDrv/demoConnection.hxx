// demoConnection.hxx -- demo HmiConnection-Class


#ifndef _demoCONNECTION_H_
#define _demoCONNECTION_H_

#include <HmiConnection.hxx>

class demoConnection : public HmiConnection
{
  public:
     
    demoConnection(DpIdType id);
